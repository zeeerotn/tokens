...
import Exchange from '~/messenger/services/exchange.service.ts';
...
export { default as Exchange } from '~/messenger/services/exchange.service.ts';
...
export { default as WebSocket } from '~/messenger/services/websocket.service.ts';
